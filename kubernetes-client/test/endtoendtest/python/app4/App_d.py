...
talk_with_a = "10.96.0.11:8090/d"
talk_with_b = "10.96.0.12:8091/d"
talk_with_c = "10.96.0.13:8092/d"
talk_with_d = "10.96.0.14:8093/d"
talk_with_e = "10.96.0.15:8094/d"
...
def send_message(talk_with):
    ...
    sys.stdout.write("Started requests form D to " +talk_with+ '\n')
...
class KodeFunHTTPRequestHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.path == '/b':
            ...
            sys.stdout.write("message D->E" + '\n')
            self.send_response_t(8000000)
            sys.stdout.write("reply B<-D" + '\n')
            return 
