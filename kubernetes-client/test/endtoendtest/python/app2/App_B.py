...
talk_with_a = "10.96.0.11:8090/b"
talk_with_b = "10.96.0.12:8091/b"
talk_with_c = "10.96.0.13:8092/b"
talk_with_d = "10.96.0.14:8093/b"
talk_with_e = "10.96.0.15:8094/b"
...
def send_message(talk_with):
    ...
    sys.stdout.write("Started requests form B to " +talk_with+ '\n')
...
class KodeFunHTTPRequestHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.path == '/a':
            ...
            sys.stdout.write("message B->C" + '\n')
            send_message(talk_with_d)
            sys.stdout.write("message B->D" + '\n')
            self.send_response_t(3000000)
            sys.stdout.write("Response A<-B" + '\n')
            return 

        if self.path == '/b':
             
            send_message(talk_with_c)
            sys.stdout.write("TEST B->C" + '\n')
